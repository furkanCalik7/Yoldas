...
class Signaling {
  ...
  Future<String> createRoom(RTCVideoRenderer remoteRenderer) async {
    ...
    print('(debug) New room created with SDK offer. Room ID: $roomId');
    currentRoomText = '(debug) Current room is $roomId - You are the caller!';
    // Created a Room
    ...
    answerSubscription = roomRef.snapshots().listen((snapshot) async {
      ...
      if (peerConnection?.getRemoteDescription() != null &&
        ...
        print("(debug) Someone tried to connect");
  ...
  Future<void> joinRoom(String roomId, RTCVideoRenderer remoteVideo) async {
    ...
    print('(debug) Got room ${roomSnapshot.exists}');
    ...
    if (roomSnapshot.exists) {
      ...
      print('(debug) Got offer $data');
      var offer = data['offer'];
      await peerConnection?.setRemoteDescription(
        RTCSessionDescription(offer['sdp'], offer['type']),
      );
      var answer = await peerConnection!.createAnswer();
      print('(debug) Created Answer $answer');
